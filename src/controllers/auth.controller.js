...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // 4) Checking if user changed password after the token was isused
...
exports.isLoggedIn = async (req, res, next) => {
  if (req.cookies.jwt) {
    try {
      ...
      // 3) Checking if user changed password after the token was isused
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    const resetURL = `${req.protocol}://${req.get("host")}/apiauth/resetpassword/${resetToken}`;
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // * 3) Update changedPasswordAt properties for the user
